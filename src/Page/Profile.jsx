...
const accountUrl = `#/${config.ownerId}/widget/Page.Profile?accountId=${accountId}`;
...
return (
  <Wrapper>
    ...
    <Main>
      <SidebarWrapper>
        <Widget
          src={`${config.discoveryAccountId}/widget/ProfilePage.Sidebar`}
          props={{
            accountId,
            profile,
          }}
      ...
      <Content>
        ...
        {state.selectedTab === "nfts" && (
          <Widget
            src={`${config.discoveryAccountId}/widget/NFTCollection`}
            props={{ accountId }}
          />
        )}
        ...
        {state.selectedTab === "apps" && (
          <Widget
            src={`${config.discoveryAccountId}/widget/ComponentCollection`}
            props={{ accountId }}
          />
        )}
        ...
        {state.selectedTab === "followers" && (
          <Widget
            src={`${config.discoveryAccountId}//widget/FollowersList`}
            props={{ accountId }}
          />
        )}
        ...
        {state.selectedTab === "following" && (
          <Widget
            src={`${config.discoveryAccountId}FollowingList`}
            props={{ accountId }}
          />
        )}
        ...
        {state.selectedTab === "explorer" && (
          <Widget
            src={`${config.discoveryAccountId}/widget/Explorer.Account`}
            props={{
              accountId,
